...
!(function (e, t) {
  ...
  function s(n, s, o) {
    function l(t, n, c) {
      if (!t && n === !0) {
        ...
        c.cycleTimeout && (clearTimeout(c.cycleTimeout), (c.cycleTimeout = 0)),
          d(s.elements, s, 1, !s.backwards);
      }
    }
    if (
      ...
      return (s = e(n).data("cycle.opts"))
        ? 0 > f || f >= s.elements.length
          ...
          : ((s.nextSlide = f),
            ...
            "string" == typeof o && (s.oneTimeFx = o),
            d(s.elements, s, 1, f >= s.currSlide),
            !1)
  ...
  function l(n, s, r, l, h) {
    ...
    if (
      ...
      x.startingSlide != t
        ? ((x.startingSlide = parseInt(x.startingSlide, 10)),
          x.startingSlide >= r.length || x.startSlide < 0
            ? (x.startingSlide = 0)
            : (p = !0))
        : x.backwards
      ...
      x.fit &&
        (x.aspect
          ? s.each(function () {
              ...
              x.width &&
                t.width() != x.width &&
                (t.width(x.width), t.height(x.width / n)),
                x.height &&
                  t.height() < x.height &&
                  (t.height(x.height), t.width(x.height * n));
            })
          : (x.width && s.width(x.width),
            x.height && "auto" != x.height && s.height(x.height))),
      !x.center ||
        (x.fit && !x.aspect) ||
        s.each(function () {
          var t = e(this);
    ...
    if (I) {
      for (var O = 0, F = 0, A = 0; A < r.length; A++) {
        var k = e(r[A]),
          ...
          T = k.outerWidth(),
          W = k.outerHeight();
        T || (T = H.offsetWidth || H.width || k.attr("width")),
          W || (W = H.offsetHeight || H.height || k.attr("height")),
          (O = T > O ? T : O),
          (F = W > F ? W : F);
      }
    ...
    if (
      ...
      (x.timeout = parseInt(x.timeout, 10)),
        x.speed.constructor == String &&
          (x.speed = e.fx.speeds[x.speed] || parseInt(x.speed, 10)),
        x.sync || (x.speed = x.speed / 2);
      for (
        var C = "none" == x.fx ? 0 : "shuffle" == x.fx ? 500 : 250;
        x.timeout - x.speed < C;
    ...
    if (
      ...
      x.random
        ? (++x.randomIndex == r.length && (x.randomIndex = 0),
          (x.nextSlide = x.randomMap[x.randomIndex]))
        : x.backwards
        ? (x.nextSlide =
            0 == x.startingSlide ? r.length - 1 : x.startingSlide - 1)
        : (x.nextSlide =
            x.startingSlide >= r.length - 1 ? 0 : x.startingSlide + 1),
      !x.multiFx)
    ) {
      var z = e.fn.cycle.transitions[x.fx];
      if (e.isFunction(z)) z(n, s, x);
      else if ("custom" != x.fx && !x.multiFx)
        return i("unknown transition: " + x.fx, "; slideshow terminating"), !1;
    }
    var E = s[B];
    return (
      x.skipInitializationCallbacks ||
        (x.before.length && x.before[0].apply(E, [E, E, x, !0]),
        x.after.length && x.after[0].apply(E, [E, E, x, !0])),
      x.next &&
  ...
  function f(t) {
    ...
    if (t.fx.indexOf(",") > 0) {
      for (
        t.multiFx = !0, t.fxs = t.fx.replace(/\s*/g, "").split(","), c = 0;
        c < t.fxs.length;
        c++
      ) {
        var r = t.fxs[c];
        (s = o[r]),
          (s && o.hasOwnProperty(r) && e.isFunction(s)) ||
            (i("discarding unknown transition: ", r), t.fxs.splice(c, 1), c--);
      }
      if (!t.fxs.length)
      ...
      (t.multiFx = !0), (t.fxs = []);
      for (p in o)
        (s = o[p]), o.hasOwnProperty(p) && e.isFunction(s) && t.fxs.push(p);
    }
  ...
  function d(i, c, s, o) {
    function r() {
      ...
      c.timeout && !c.continuous
        ? ((e = h(i[c.currSlide], i[c.nextSlide], c, o)),
          "shuffle" == c.fx && (e -= c.speedOut))
        : c.continuous && l.cyclePause && (e = 10),
        e > 0 &&
    ...
    if (l.cycleStop == c.stopCount && (0 !== l.cycleTimeout || s)) {
      ...
      if ((!s && l.cyclePause) || c.nextSlide == c.currSlide) r();
        ...
        (a.cycleH = a.cycleH || e(a).height()),
          ...
          c.multiFx &&
            (o && (c.lastFx == t || ++c.lastFx >= c.fxs.length)
              ? (c.lastFx = 0)
              : !o &&
        ...
        n(
          ...
          (c.busy = 1),
          c.fxFn
            ? c.fxFn(a, f, c, m, o, s && c.fastOnEvent)
            : e.isFunction(e.fn.cycle[c.fx])
            ? e.fn.cycle[c.fx](a, f, c, m, o, s && c.fastOnEvent)
            : e.fn.cycle.custom(a, f, c, m, o, s && c.fastOnEvent);
      }
        ...
        if (((c.lastSlide = c.currSlide), c.random))
          ...
          y && c.bounce
            ? ((c.backwards = !c.backwards),
              (c.nextSlide = 1),
              (c.currSlide = 0))
            : ((c.nextSlide = y ? i.length - 1 : c.nextSlide - 1),
              (c.currSlide = y ? 0 : c.nextSlide + 1));
        } else {
          ...
          y && c.bounce
            ...
            : ((c.nextSlide = y ? 0 : c.nextSlide + 1),
              (c.currSlide = y ? i.length - 1 : c.nextSlide - 1));
        }
      u &&
        c.pager &&
  ...
  function h(e, t, i, c) {
    if (i.timeoutFn) {
      for (
        ...
        s += i.speed;
      if ((n("calculated timeout: " + s + "; speed: " + i.speed), s !== !1))
        return s;
    }
    return i.timeout;
  }
  function m(t, n) {
    ...
    return (
      e.isFunction(r) && r(i > 0, t.nextSlide, c[t.nextSlide]),
      d(c, t, 1, n),
      !1
    );
  }
  ...
  e.support == t && (e.support = { opacity: !e.browser.msie }),
    ...
    (e.fn.cycle = function (t, c) {
      ...
      return 0 === this.length && "stop" != t
        ...
        : this.each(function () {
            var r = s(this, t, c);
            if (r !== !1) {
              (r.updateActivePagerLink =
                r.updateActivePagerLink || e.fn.cycle.updateActivePagerLink),
              ...
              if (p !== !1) {
                ...
                var m = p.continuous
                  ? 10
                  : h(u[p.currSlide], u[p.nextSlide], p, !p.backwards);
                m &&
                  ((m += p.delay || 0),
                  10 > m && (m = 10),
                  n("first timeout: " + m),
    ...
    (e.fn.cycle.createPagerAnchor = function (t, i, s, o, r) {
      var l;
      if (
        (e.isFunction(r.pagerAnchorBuilder)
          ? ((l = r.pagerAnchorBuilder(t, i)),
            n("pagerAnchorBuilder(" + t + ", el) returned: " + l))
          : (l = '<a href="#">' + (t + 1) + "</a>"),
        l)
      ) {
        var a = e(l);
        ...
        var u = function (n) {
          ...
          e.isFunction(s) && s(r.nextSlide, o[r.nextSlide]),
            d(o, r, 1, r.currSlide < t);
        };
        /mouseenter|mouseover/i.test(r.pagerEvent)
          ? a.hover(u, function () {})
          : a.bind(r.pagerEvent, u),
      ...
      (e.fn.cycle.transitions.shuffle = function (t, n, i) {
        ...
        (i.fxFn = function (t, n, i, c, s) {
          ...
          o.animate(i.shuffle, i.speedIn, i.easeIn, function () {
            for (var n = e.fn.cycle.hopsFromLast(i, s), l = 0; n > l; l++)
              s ? i.els.push(i.els.shift()) : i.els.unshift(i.els.pop());
            if (s)
              for (var a = 0, f = i.els.length; f > a; a++)
...
!(function (e) {
  ...
  (e.fn.maximage = function (i, t) {
    ...
    ("object" == typeof i || void 0 === i) &&
      (d = e.extend(e.fn.maximage.defaults, i || {})),
      ...
      this.each(function () {
        var t = e(this),
          ...
          o = {
            ...
            preload: function (i) {
              var a = e("<img/>");
              a.on("load", function () {
                0 == n && (c.setup(), d.onFirstImageLoaded()),
                  n == e.Slides.length - 1
                    ? d.onImagesLoaded(t)
                    : (n++, o.preload(n));
              }),
              ...
              e.Window.bind(e.Events.RESIZE, function () {
                e.Scroll.addClass("mc-hide-scrolls"),
                  ...
                  t.children().each(function () {
                    (this.cycleH = e.Window.data("h")),
                      (this.cycleW = e.Window.data("w"));
                  }),
          ...
          r = {
            setup: function () {
              ...
              if (
                ...
                t.html(""),
                e.Body.addClass("mc-old-browser"),
                e.Slides.length > 0)
              ) {
                for (
                  e.Scroll.addClass("mc-hide-scrolls"),
                  ...
                  (i =
                    0 == e.Slides[n].content.length
                      ? '<img src="' + e.Slides[n].url + '" />'
                      : e.Slides[n].content),
                    (a = e("<div>" + i + "</div>").attr(
                      "class",
                      "mc-image mc-image-n" + n + " " + e.Slides[n].theclass
                    )),
                    t.append(a),
            ...
            preload: function () {
              var i = setInterval(function () {
                e(".mc-loader")
                  ...
                  0 == e(".not-loaded").length &&
                    (e(".mc-loader").remove(), clearInterval(i));
              }, 1e3);
            },
            ...
            windowResize: function () {
              e.Window.bind(e.Events.RESIZE, function () {
                clearTimeout(this.id),
                  e(".mc-image").length >= 1 &&
                    (this.id = setTimeout(r.doneResizing, 200));
              });
            },
            doneResizing: function () {
              ...
              void 0 != i &&
                ...
                jQuery.each(i.elements, function (i, t) {
                  (t.cycleW = e.Window.data("w")),
                    (t.cycleH = e.Window.data("h"));
                })),
                e(e.Scroll).removeClass("mc-hide-scrolls");
            },
          },
              ...
              var i = e.extend(
                {
                  ...
                  slideResize: !1,
                  easing:
                    e.BrowserTests.cssTransitions && d.cssTransitions
            ...
            fill: function (i) {
              ...
              "function" == typeof d.backgroundSize
                ...
                ? e.Window.data("w") / e.Window.data("h") < t.data("ar")
                  ? i
                      .height(e.Window.data("h"))
                      .width((e.Window.data("h") * t.data("ar")).toFixed(0))
                  : i
                      .height((e.Window.data("w") / t.data("ar")).toFixed(0))
                      .width(e.Window.data("w"))
          ...
          h = {
            browser_tests: function () {
              ...
              if (d.cssTransitions) {
                "string" == typeof i.style[n] && (s.cssTransitions = !0),
                  (n = n.charAt(0).toUpperCase() + n.substr(1));
                for (var o = 0; o < t.length; o++)
                  t[o] + n in i.style && (s.cssTransitions = !0);
              }
              return (
                document.createElement("video").canPlayType &&
                  (s.html5Video = !0),
                (s.msie = void 0 !== h.msie()),
                d.debug && (a(" - Browser Test - "), a(s)),
                s
              );
            },
            construct_slide_object: function () {
              ...
              return (
                t.children().each(function (t) {
                  var a = e(this).is("img")
                    ? e(this).clone()
                    : e(this).find("img").first().clone();
                  (i = {}),
                    (i.url = a.attr("src")),
                    (i.title =
                      void 0 != a.attr("title") ? a.attr("title") : ""),
                    (i.alt = void 0 != a.attr("alt") ? a.attr("alt") : ""),
                    (i.theclass =
                      void 0 != a.attr("class") ? a.attr("class") : ""),
                    (i.styles =
                      void 0 != a.attr("style") ? a.attr("style") : ""),
                    (i.orig = a.clone()),
                    (i.datahref =
                      void 0 != a.attr("data-href") ? a.attr("data-href") : ""),
                    (i.content = ""),
                    e(this).find("img").length > 0 &&
                      (e.BrowserTests.cssBackgroundSize &&
                        e(this).find("img").first().remove(),
                      (i.content = e(this).html())),
                    (a[0].src = ""),
            ...
            sizes: function () {
              var i = { h: 0, w: 0 };
              if ("window" == d.fillElement)
                (i.h = e.Window.height()), (i.w = e.Window.width());
              else {
                var a = t.parents(d.fillElement).first();
                0 == a.height() || 1 == a.data("windowHeight")
                  ? (a.data("windowHeight", !0), (i.h = e.Window.height()))
                  : (i.h = a.height()),
                  0 == a.width() || 1 == a.data("windowWidth")
                    ? (a.data("windowWidth", !0), (i.w = e.Window.width()))
                    : (i.w = a.width());
              }
              return i;
            },
        ...
        if (((e.BrowserTests = h.browser_tests()), "string" == typeof i)) {
          if (e.BrowserTests.html5Video || !t.is("video")) {
            ...
            e.Body.hasClass("mc-old-browser") ||
              e.Body.addClass("mc-old-browser"),
              e.Window.data("h", h.sizes().h).data("w", h.sizes().w),
              g
                .data("h", t.height())
